...
add wave -noupdate -color Red /tb_display_timing_controller/DUT/active_video_area
add wave -noupdate -divider Horizontal
add wave -noupdate -expand -group Horizontal -radix unsigned /tb_display_timing_controller/DUT/hor_ctr_q
add wave -noupdate -expand -group Horizontal -radix unsigned /tb_display_timing_controller/DUT/x
add wave -noupdate -expand -group Horizontal /tb_display_timing_controller/DUT/hor_act
...
WaveRestoreCursors {{Cursor 1} {17925740000 ps} 0}
...
update
WaveRestoreZoom {17908939942 ps} {17939701670 ps}
